...
`,ee=document.documentElement.clientWidth*.9,de=document.documentElement.clientHeight*.9;let Ke=130;const Ze=-23.5,q=u(0,0,2);let _e=0,ue=0;const Qe=u(0,0,2.5),Je=u(0,0,1.5),et=u(0,1,0),pe=new Pe(ee,de),_=pe.gl,b=new le(_,Ye,ke),tt=_.getUniformLocation(b.id,"model"),it=_.getUniformLocation(b.id,"projection"),rt=_.getUniformLocation(b.id,"view"),nt=_.getUniformLocation(b.id,"camPos"),ot=_.getUniformLocation(b.id,"lightPos"),k=new le(_,qe,$e),st=_.getUniformLocation(k.id,"projection"),at=_.getUniformLocation(k.id,"view"),U={envCubemapImages:!1,irradianceCubemapImages:!1,textureLoaded:!1};function te(){U.envCubemapImages&&U.irradianceCubemapImages&&U.textureLoaded&&(document.getElementById("loader").style.display="none")}let ie=!1,K,Z;const L=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),lt=L?"touchstart":"mousedown",ct=L?"touchmove":"mousemove",ht=L?"touchend":"mouseup";document.addEventListener(lt,e=>{ie=!0,K=L?e.touches[0].clientX:e.clientX,Z=L?e.touches[0].clientY:e.clientY});document.addEventListener(ct,e=>{if(ie){const t=L?e.touches[0].clientX:e.clientX,i=L?e.touches[0].clientY:e.clientY,r=t-K,n=i-Z;_e+=n/10,ue+=r/10,K=t,Z=i,e.preventDefault()}});document.addEventListener(ht,()=>{ie=!1});const gt=["https://waynechoidev.github.io/web-pbr/pbr/antique-grate1-height.jpg","https://waynechoidev.github.io/web-pbr/pbr/antique-grate1-albedo.jpg","https://waynechoidev.github.io/web-pbr/pbr/antique-grate1-normal-dx.jpg","https://waynechoidev.github.io/web-pbr/pbr/antique-grate1-metallic.jpg","https://waynechoidev.github.io/web-pbr/pbr/antique-grate1-roughness.jpg","https://waynechoidev.github.io/web-pbr/pbr/antique-grate1-ao.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_brdf.jpg"],fe=new I(_,"heightMap"),ve=new I(_,"albedoMap"),be=new I(_,"normalMap"),Ee=new I(_,"metallicMap"),xe=new I(_,"roughnessMap"),Te=new I(_,"aoMap"),ye=new I(_,"brdfLUT"),mt=async()=>{const e=gt.map(t=>new Promise((i,r)=>{const n=new Image;n.src=t,n.crossOrigin="anonymous",n.onload=()=>{i(n)},n.onerror=()=>{r(new Error("Image loading failed"))}}));try{const t=await Promise.all(e);fe.initialise(t[0]),ve.initialise(t[1]),be.initialise(t[2]),Ee.initialise(t[3]),xe.initialise(t[4]),Te.initialise(t[5]),ye.initialise(t[6]),U.textureLoaded=!0,te()}catch(t){console.error("Error loading cubemap images:",t)}},Q=new me(_,"envCubemap"),dt=["https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_env_px.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_env_nx.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_env_py.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_env_ny.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_env_pz.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_env_nz.jpg"],_t=async()=>{const e=dt.map(t=>new Promise((i,r)=>{const n=new Image;n.src=t,n.crossOrigin="anonymous",n.onload=()=>{i(n)},n.onerror=()=>{r(new Error("Image loading failed"))}}));try{const t=await Promise.all(e);Q.initialise(t),U.envCubemapImages=!0,te()}catch(t){console.error("Error loading env cubemap images:",t)}},we=new me(_,"irradianceCubemap"),ut=["https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_irradiance_px.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_irradiance_nx.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_irradiance_py.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_irradiance_ny.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_irradiance_pz.jpg","https://waynechoidev.github.io/web-pbr/cubemap/air_museum_playground_irradiance_nz.jpg"],pt=async()=>{const e=ut.map(t=>new Promise((i,r)=>{const n=new Image;n.src=t,n.crossOrigin="anonymous",n.onload=()=>{i(n)},n.onerror=()=>{r(new Error("Image loading failed"))}}));try{const t=await Promise.all(e);we.initialise(t),U.irradianceCubemapImages=!0,te()}catch(t){console.error("Error loading cubemap images:",t)}},Ae=new We(_,ee>=500?.6:.4);Ae.initialise();const Re=new He(_,1);Re.initialise();const J=R();Se(J,z(45),ee/de,.1,100);function Me(e){pe.clear();const t=R();Fe(t,t,z(Ze)),ne(t,t,z(Ke));const i=R(),r=R();ne(r,r,z(ue)),Ue(r,r,z(_e));const n=x(),o=x(),s=x();W(n,Qe,r),W(o,Je,r),W(s,et,r),De(i,n,o,s),b.use(),_.uniformMatrix4fv(tt,!1,t),_.uniformMatrix4fv(rt,!1,i),_.uniformMatrix4fv(it,!1,J),_.uniform3f(nt,n[0],n[1],n[2]),_.uniform3f(ot,q[0],q[1],q[2]),fe.use(b.id,0),ve.use(b.id,3),be.use(b.id,4),Ee.use(b.id,5),xe.use(b.id,6),Te.use(b.id,7),ye.use(b.id,8),Q.use(b.id,9),we.use(b.id,10),Ae.draw(),_.depthFunc(_.LEQUAL),k.use(),_.uniformMatrix4fv(at,!1,i),_.uniformMatrix4fv(st,!1,J),Q.use(k.id,0),Re.draw(),_.depthFunc(_.LESS),_.useProgram(null),_.bindTexture(_.TEXTURE_2D,null),_.bindTexture(_.TEXTURE_CUBE_MAP,null),window.requestAnimationFrame(Me)}const ft=async()=>{await _t(),await pt(),await mt(),Me()};ft();
