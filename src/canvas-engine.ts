...
export class CanvasEngine {
  ...
  initialize(width: number, height: number) {
    ...
    this._texCoord = this.prepareRectVec2(0.0, 0.0, 1.0, 1.0);

    this._buffer = this.createAndBindBuffer(this._vertices);
    this._texBuffer = this.createAndBindBuffer(this._texCoord);
  ...
  private createAndBindBuffer(data: Float32Array) {
